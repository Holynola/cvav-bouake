...
if (isset($_POST['ajouter'])) {
    ...
    $url = "mdf-fiche.php?idF=$idF&militant=$militant&doyenne=$doyenne&section=$section&niveau=$niveau&titre=$titre&pfullname=$pfullname&pjob=$pjob&quartier=$quartier&pnumber=$pnumber&parent=$parent";
    header("Location: " . $url);
}
